...
<head>
    ...
    <script type="text/javascript">
        ...
        var api = {
            // 获取配置数据接口
            getData: '/index.php?r=game/game/content&auth_name=id&id=1&tx=3f556f66353c5945a3633ae209a3e0ff',
            // 抽奖接口
            tapped: '/index.php?r=game/game/content&auth_name=id&id=1&tx=3f556f66353c5945a3633ae209a3e0ff',
        };
...
//                        restaraunts:["呵呵","嘿嘿","哈哈","得到"],
            ...
            $('.pointer').click(function () {
                ...
                $.ajax({
                    ...
                    complete: function () {
                        // 这里模拟请求成功，设置好API请注释这里
                        var data = {item: rnd(1, turnplate.restaraunts.length), msg: '恭喜中奖啦!~'};
                        rotateFn(data);
                    }
                });
...
<div class="banner">
    <div class="turnplate" style="background-image:url(/assets/dial/images/cj_bg.png);background-size:100% 100%;">
        ...
        <img class="pointers" src="/assets/dial/images/jt2.png"/>
    </div>
</div>
<a href="#" class="more"></a>
<!--<img src="./dial/images/9.png" class="cloud">-->
<!--<img src="./dial/images/10.png" class="cloud2">-->
<!--<img src="./dial/images/11.png" class="cloud3">-->
